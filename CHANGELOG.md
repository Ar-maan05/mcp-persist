...
- **`docs/cli.md`**: full `doctor` and `stats` reference — sample output, `--json`, and exit-code semantics.
- **`docs/api.md`**: programmatic feature reference — `subscribe`, `migrate`, metrics, compression, `PurgeScheduler`, `event_store_from_env`, and `ping`.
